...
Stateless streamable HTTP per MCP spec 2025-11-25. OAuth discovery: [`/.well-known/oauth-protected-resource/mcp`](https://mcp.atmita.com/.well-known/oauth-protected-resource/mcp). The server implementation lives in Atmita's main (private) codebase; this repo is its public front door.
